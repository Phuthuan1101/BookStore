...
/**
 * Servlet implementation class LichsuamuahangController
 */
@WebServlet("/LichsuamuahangController")
public class LichsuamuahangController extends HttpServlet {
	private static final long serialVersionUID = 1L;
      
    public LichsuamuahangController() {
        super();
    }
...
// 				session.setAttribute("MaHoaDon", hoaDon.getMaHoaDon());
 				ChiTietHoaDonDao CTHDDao = new ChiTietHoaDonDao();//khai báo chi tiet hoa don dao để láy  hàm gettheomaHoaDon
 	 			ArrayList<LichSubean> LichsuBean = CTHDDao.GetDSTheoMaHoaDon(user.getMakh());//lấy  ra  mảng  chi tiết  hóa dơn trong database tu ma hoa đơn
 	 			session.setAttribute("lichsumua",LichsuBean);//gắn atrrinbute để gọi lại trong lichsumuahang.jsp
